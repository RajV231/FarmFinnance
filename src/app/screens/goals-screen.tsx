              ...
              <div className="relative px-6 py-6 text-white">
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-orange-100 font-medium">{t('goals_subtitle')}</p>
                    </div>
                </div>
                            ...
                            <div className="p-6">
                                ...
                                {!isAchieved && (
                                    <div className="mb-4">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                            <div className={`h-3 rounded-full transition-all duration-700 ${isMain ? 'bg-gradient-to-r from-amber-500 to-orange-500' : 'bg-gradient-to-r from-gray-400 to-gray-500'}`} style={{ width: `${progress}%` }}></div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {isAchieved && (
                                    <div className="w-full py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold text-center rounded-2xl flex items-center justify-center gap-2 shadow-md">
                                        <CheckCircle className="w-5 h-5" />{t('goals_completed')}
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full p-6 animate-scale-in">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button onClick={confirmAchievement} className="flex-1 py-3 rounded-xl font-bold text-white bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 active:scale-95 transition-all shadow-lg">{t('ui_confirm')}</button>
                        </div>
                    </div>
                </div>
            )}
