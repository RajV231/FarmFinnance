...
export const DashboardScreen = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-gray-50 relative pb-24">
        ...
        {/* REDESIGNED HEADER - Modern Green Gradient */}
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 rounded-b-[2.5rem]"></div>
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-40"></div>
          ...
          <div className="relative px-6 pt-8 pb-6 text-white">
            ...
            {/* Quick Stats - Redesigned as Pills */}
        ...
        <div className="relative z-10 flex-1 overflow-y-auto scrollbar-hide px-4 -mt-4">
            ...
            {/* Farm Visualizer Card - Elevated Design */}
            <div className="mb-6">
                <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                     ...
                     <div className="p-4 bg-gradient-to-br from-gray-50 to-white border-t border-gray-100">
                         <div className="flex justify-between items-center">
                            <div>
                              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">Your Farm</span>
                              <span className="text-sm font-bold text-gray-800">{state.totalAcres} {t('ui_acres')} • {state.farmType}</span>
                            </div>
                            <button 
            ...
            <div className="mb-6">
                <div className="flex justify-between items-center mb-3 px-1">
                  <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Financial Health</h3>
                </div>
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className={`bg-gradient-to-br ${state.debt > 0 ? 'from-red-50 to-pink-50' : 'from-green-50 to-emerald-50'} p-5 rounded-2xl border ${state.debt > 0 ? 'border-red-100' : 'border-green-100'} shadow-sm`}>
                        <div className="flex items-center gap-2 mb-2">
                          <div className={`w-8 h-8 ${state.debt > 0 ? 'bg-red-600' : 'bg-green-600'} rounded-xl flex items-center justify-center`}>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-2xl border border-blue-100 shadow-sm">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <div className="text-xs text-blue-700 font-semibold uppercase tracking-wide">Govt. Benefits</div>
                        </div>
                ...
                <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-5 text-white">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="text-sm font-semibold opacity-90 uppercase tracking-wider block">{t('credit_score')}</span>
                                  <span className="text-3xl font-bold font-mono">{state.creditScore}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="p-5">
                        ...
                        <div className={`${state.creditScore >= 700 ? 'bg-green-50 text-green-700 border-green-200' : 'bg-blue-50 text-blue-700 border-blue-200'} text-sm p-3 rounded-xl border font-medium`}>
                            {state.creditScore >= 700 ? "✓ You qualify for KCC (7% interest)! Great job." : "💡 Repay loans on time to increase your score."}
                        </div>
                    </div>
                </div>
            </div>

            {/* RESILIENCE & GOAL - Side by Side */}
            <div className="mb-6 space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-emerald-600 to-green-600 p-5 text-white">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="text-sm font-semibold opacity-90 uppercase tracking-wider block">Resilience Score</span>
                                  <span className="text-3xl font-bold font-mono">{state.resilienceScore}/100</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="p-5">
                        <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${state.resilienceScore}%` }}
                            ></div>
                        </div>
                    </div>
                </div>
                ...
                {state.financialGoal && (
                    <div 
                      className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden cursor-pointer active:scale-98 transition-transform" 
                    ...
                    >
                        <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-5 text-white">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                  <span className="text-sm font-semibold opacity-90 uppercase tracking-wider block">Dream Goal</span>
                                  <span className="text-lg font-bold">{t(state.financialGoal.nameKey)}</span>
                                </div>
                            </div>
                        </div>
                        <div className="p-5">
                            <div className="flex justify-between text-sm font-bold text-gray-600 mb-2">
                                <span>Saved: ₹{state.savings.toLocaleString()}</span>
                                <span>Target: ₹{state.financialGoal.targetAmount.toLocaleString()}</span>
                            </div>
                            <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                <div 
